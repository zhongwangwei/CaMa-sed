...
USE CMF_VARS_MOD,       ONLY: NSEQALL,      NPTHOUT,      NPTHLEV
USE CMF_VARS_MOD,       ONLY: D2RIVOUT,     D2FLDOUT,     D1PTHFLW,     D2GDWRTN, &
                            & D2RUNOFF,     D2ROFSUB,     P2DAMINF
USE CMF_VARS_MOD,       ONLY: D2OUTFLW,     D2RIVVEL,     D2PTHOUT,     D2PTHINF, &
                            & D2RIVDPH,     D2STORGE,     D2WEVAPEX
USE CMF_VARS_MOD,       ONLY: D2RIVOUT_aAVG, D2FLDOUT_aAVG, D1PTHFLW_aAVG, D2GDWRTN_aAVG, D2RUNOFF_aAVG, D2ROFSUB_aAVG, &
...
USE CMF_VARS_MOD,       ONLY: D2RIVOUT_oAVG, D2FLDOUT_oAVG, D1PTHFLW_oAVG, D2GDWRTN_oAVG, D2RUNOFF_oAVG, D2ROFSUB_oAVG, &
                            & D2OUTFLW_oAVG, D2RIVVEL_oAVG, D2PTHOUT_oAVG, D2DAMINF_oAVG, D2WEVAPEX_oAVG, &
                            & D2OUTFLW_oMAX, D2RIVDPH_oMAX, D2STORGE_oMAX, NADD_out
USE CMF_VARS_MOD,        ONLY: d2rivout_sed, d2rivvel_sed, sadd_riv
IMPLICIT NONE
CONTAINS 
!####################################################################
...
USE CMF_VARS_MOD,       ONLY: JYYYYMMDD, JHHMM
IMPLICIT NONE
!================================================
...
!====================
NADD_adp=NADD_adp+CMF_CONFIG%DT
!$OMP PARALLEL DO
DO ISEQ=1, NSEQALL
  D2RIVOUT_aAVG(ISEQ,1)=D2RIVOUT_aAVG(ISEQ,1)+D2RIVOUT(ISEQ,1)*CMF_CONFIG%DT
  D2FLDOUT_aAVG(ISEQ,1)=D2FLDOUT_aAVG(ISEQ,1)+D2FLDOUT(ISEQ,1)*CMF_CONFIG%DT
  D2RIVVEL_aAVG(ISEQ,1)=D2RIVVEL_aAVG(ISEQ,1)+D2RIVVEL(ISEQ,1)*CMF_CONFIG%DT
  D2OUTFLW_aAVG(ISEQ,1)=D2OUTFLW_aAVG(ISEQ,1)+D2OUTFLW(ISEQ,1)*CMF_CONFIG%DT

  D2PTHOUT_aAVG(ISEQ,1)=D2PTHOUT_aAVG(ISEQ,1)+D2PTHOUT(ISEQ,1)*CMF_CONFIG%DT-D2PTHINF(ISEQ,1)*CMF_CONFIG%DT

  D2GDWRTN_aAVG(ISEQ,1)=D2GDWRTN_aAVG(ISEQ,1)+D2GDWRTN(ISEQ,1)*CMF_CONFIG%DT
  D2RUNOFF_aAVG(ISEQ,1)=D2RUNOFF_aAVG(ISEQ,1)+D2RUNOFF(ISEQ,1)*CMF_CONFIG%DT
  D2ROFSUB_aAVG(ISEQ,1)=D2ROFSUB_aAVG(ISEQ,1)+D2ROFSUB(ISEQ,1)*CMF_CONFIG%DT
  ...
  IF( CMF_OPTIONS%LWEVAP )THEN
    D2WEVAPEX_aAVG(ISEQ,1)= D2WEVAPEX_aAVG(ISEQ,1) +D2WEVAPEX(ISEQ,1)*CMF_CONFIG%DT
  ENDIF
END DO
!$OMP END PARALLEL DO
...
IF( CMF_OPTIONS%LDAMOUT )THEN
  !$OMP PARALLEL DO
  DO ISEQ=1, NSEQALL
    D2DAMINF_aAVG(ISEQ,1)=D2DAMINF_aAVG(ISEQ,1)+P2DAMINF(ISEQ,1)*CMF_CONFIG%DT
  END DO
  !$OMP END PARALLEL DO
ENDIF
...
!$OMP PARALLEL DO
  DO IPTH=1, NPTHOUT
    D1PTHFLW_aAVG(IPTH,:)=D1PTHFLW_aAVG(IPTH,:)+D1PTHFLW(IPTH,:)*CMF_CONFIG%DT
  END DO
!$OMP END PARALLEL DO
ENDIF
...
IF( CMF_OPTIONS%LSEDOUT )THEN
  sadd_riv = sadd_riv + CMF_CONFIG%DT
  !$OMP PARALLEL DO
  DO ISEQ=1, NSEQALL
    d2rivout_sed(ISEQ) = d2rivout_sed(ISEQ)+D2RIVOUT(ISEQ,1)*CMF_CONFIG%DT
    d2rivvel_sed(ISEQ) = d2rivvel_sed(ISEQ)+D2RIVVEL(ISEQ,1)*CMF_CONFIG%DT
  END DO
  !$OMP END PARALLEL DO
ENDIF
...
!================================================
WRITE(CMF_FILES%LOGNAM,*) "CMF::DIAG_AVERAGE: time-average", NADD_adp, JYYYYMMDD, JHHMM
...
!$OMP PARALLEL DO
DO ISEQ=1, NSEQALL
  D2RIVOUT_oAVG(ISEQ,1)=D2RIVOUT_oAVG(ISEQ,1)+D2RIVOUT_aAVG(ISEQ,1)*CMF_CONFIG%DT
  D2FLDOUT_oAVG(ISEQ,1)=D2FLDOUT_oAVG(ISEQ,1)+D2FLDOUT_aAVG(ISEQ,1)*CMF_CONFIG%DT
  D2RIVVEL_oAVG(ISEQ,1)=D2RIVVEL_oAVG(ISEQ,1)+D2RIVVEL_aAVG(ISEQ,1)*CMF_CONFIG%DT
  D2OUTFLW_oAVG(ISEQ,1)=D2OUTFLW_oAVG(ISEQ,1)+D2OUTFLW_aAVG(ISEQ,1)*CMF_CONFIG%DT

  D2PTHOUT_oAVG(ISEQ,1)=D2PTHOUT_oAVG(ISEQ,1)+D2PTHOUT_aAVG(ISEQ,1)*CMF_CONFIG%DT

  D2GDWRTN_oAVG(ISEQ,1)=D2GDWRTN_oAVG(ISEQ,1)+D2GDWRTN_aAVG(ISEQ,1)*CMF_CONFIG%DT
  D2RUNOFF_oAVG(ISEQ,1)=D2RUNOFF_oAVG(ISEQ,1)+D2RUNOFF_aAVG(ISEQ,1)*CMF_CONFIG%DT
  D2ROFSUB_oAVG(ISEQ,1)=D2ROFSUB_oAVG(ISEQ,1)+D2ROFSUB_aAVG(ISEQ,1)*CMF_CONFIG%DT
  ...
  IF( CMF_OPTIONS%LWEVAP )THEN
    D2WEVAPEX_oAVG(ISEQ,1)= D2WEVAPEX_oAVG(ISEQ,1) +D2WEVAPEX_aAVG(ISEQ,1)*CMF_CONFIG%DT
  ENDIF
END DO
!$OMP END PARALLEL DO
...
IF( CMF_OPTIONS%LDAMOUT )THEN
  !$OMP PARALLEL DO
  DO ISEQ=1, NSEQALL
    D2DAMINF_oAVG(ISEQ,1)=D2DAMINF_oAVG(ISEQ,1)+D2DAMINF_aAVG(ISEQ,1)*CMF_CONFIG%DT
  END DO
  !$OMP END PARALLEL DO
ENDIF
...
IF( CMF_OPTIONS%LPTHOUT )THEN
  !$OMP PARALLEL DO
  DO IPTH=1, NPTHOUT
    D1PTHFLW_oAVG(IPTH,:)=D1PTHFLW_oAVG(IPTH,:)+D1PTHFLW_aAVG(IPTH,:)*CMF_CONFIG%DT
  END DO
  !$OMP END PARALLEL DO
ENDIF
...
IMPLICIT NONE
!================================================
WRITE(CMF_FILES%LOGNAM,*) "CMF::DIAG_AVERAGE: time-average", NADD_out, JYYYYMMDD, JHHMM
